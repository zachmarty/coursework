    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='example@example.com', max_length=75, unique=True, verbose_name='Почта')),
                ('role', models.CharField(choices=[('1', 'user'), ('2', 'ADMIN')], default='1', verbose_name='Роль')),
